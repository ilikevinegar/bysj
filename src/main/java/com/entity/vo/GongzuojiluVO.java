...
public class GongzuojiluVO  implements Serializable {
	...
	public void setGongzuofujian(String gongzuofujian) {
		this.gongzuofujian = gongzuofujian;
	}
	
	/**
	 * 获取：工作附件
	 */
	public String getGongzuofujian() {
		return gongzuofujian;
	}
