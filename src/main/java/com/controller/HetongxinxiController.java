...
public class HetongxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,HetongxinxiEntity hetongxinxi, 
		...
		if(tableName.equals("yuangong")) {
			hetongxinxi.setYuangonggonghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("bumenlingdao")) {
			hetongxinxi.setLingdaozhanghao((String)request.getSession().getAttribute("username"));
		}
