<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="人员" prop="renyuan">
          <el-input v-model="ruleForm.renyuan" 
              placeholder="人员" clearable  :readonly="ro.renyuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="人员" prop="renyuan">
              <el-input v-model="ruleForm.renyuan" 
                placeholder="人员" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="教育经历" prop="jiaoyujingli">
          <el-input v-model="ruleForm.jiaoyujingli" 
              placeholder="教育经历" clearable  :readonly="ro.jiaoyujingli"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="教育经历" prop="jiaoyujingli">
              <el-input v-model="ruleForm.jiaoyujingli" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="工作经历" prop="gongzuojingli">
          <el-input v-model="ruleForm.gongzuojingli" 
              placeholder="工作经历" clearable  :readonly="ro.gongzuojingli"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="工作经历" prop="gongzuojingli">
              <el-input v-model="ruleForm.gongzuojingli" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="家庭背景" prop="jiatingbeijing">
          <el-input v-model="ruleForm.jiatingbeijing" 
              placeholder="家庭背景" clearable  :readonly="ro.jiatingbeijing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="家庭背景" prop="jiatingbeijing">
              <el-input v-model="ruleForm.jiatingbeijing" 
                placeholder="家庭背景" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="培训经历" prop="peixunjingli">
          <el-input v-model="ruleForm.peixunjingli" 
              placeholder="培训经历" clearable  :readonly="ro.peixunjingli"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="培训经历" prop="peixunjingli">
              <el-input v-model="ruleForm.peixunjingli" 
                placeholder="培训经历" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="语言能力" prop="yuyannengli">
          <el-input v-model="ruleForm.yuyannengli" 
              placeholder="语言能力" clearable  :readonly="ro.yuyannengli"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="语言能力" prop="yuyannengli">
              <el-input v-model="ruleForm.yuyannengli" 
                placeholder="语言能力" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="个人职称" prop="gerenzhicheng">
          <el-input v-model="ruleForm.gerenzhicheng" 
              placeholder="个人职称" clearable  :readonly="ro.gerenzhicheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="个人职称" prop="gerenzhicheng">
              <el-input v-model="ruleForm.gerenzhicheng" 
                placeholder="个人职称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.touxiang = true;
          ...
          if(o=='renyuan'){
            this.ruleForm.renyuan = obj[o];
	    this.ro.renyuan = true;
            continue;
          }
          if(o=='zhiwei'){
	    ...
	    this.ro.gongzuojingli = true;
          ...
          if(o=='jiatingbeijing'){
            this.ruleForm.jiatingbeijing = obj[o];
	    this.ro.jiatingbeijing = true;
            continue;
          }
          if(o=='peixunjingli'){
	    ...
	    this.ro.yuyannengli = true;
          ...
          if(o=='gerenzhicheng'){
            this.ruleForm.gerenzhicheng = obj[o];
	    this.ro.gerenzhicheng = true;
            continue;
          }
