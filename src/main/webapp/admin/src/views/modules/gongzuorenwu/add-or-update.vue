<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="任务要求" prop="renwuyaoqiu">
          <el-input v-model="ruleForm.renwuyaoqiu" 
              placeholder="任务要求" clearable  :readonly="ro.renwuyaoqiu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="任务要求" prop="renwuyaoqiu">
              <el-input v-model="ruleForm.renwuyaoqiu" 
                placeholder="任务要求" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.renwufujian" label="任务附件" prop="renwufujian">
          <file-upload
          tip="点击上传任务附件"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.renwufujian" label="任务附件" prop="renwufujian">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.renwufujian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="任务内容" prop="renwuneirong">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.renwuneirong" label="任务内容" prop="renwuneirong">
                    <span>{{ruleForm.renwuneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
