<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="模板编号" prop="hetongbianhao">
            <el-input v-model="ruleForm.hetongbianhao" 
                placeholder="模板编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.hetongbianhao" label="模板编号" prop="hetongbianhao">
              <el-input v-model="ruleForm.hetongbianhao" 
                placeholder="模板编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="模板名称" prop="hetongmingcheng">
          <el-input v-model="ruleForm.hetongmingcheng" 
              placeholder="模板名称" clearable  :readonly="ro.hetongmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="模板名称" prop="hetongmingcheng">
              <el-input v-model="ruleForm.hetongmingcheng" 
                placeholder="模板名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="模板类型" prop="hetongleixing">
          <el-select :disabled="ro.hetongleixing" v-model="ruleForm.hetongleixing" placeholder="请选择模板类型">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="模板类型" prop="hetongleixing">
	      <el-input v-model="ruleForm.hetongleixing"
                placeholder="模板类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.hetongwenjian" label="模板文件" prop="hetongwenjian">
          <file-upload
          tip="点击上传模板文件"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.hetongwenjian" label="模板文件" prop="hetongwenjian">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.hetongwenjian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="模板信息" prop="hetongxinxi">
          <el-input v-model="ruleForm.hetongxinxi" 
              placeholder="模板信息" clearable  :readonly="ro.hetongxinxi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="模板信息" prop="hetongxinxi">
              <el-input v-model="ruleForm.hetongxinxi" 
                placeholder="模板信息" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="模板说明" prop="hetongshuoming">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="模板说明"
                  v-model="ruleForm.hetongshuoming" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.hetongshuoming" label="模板说明" prop="hetongshuoming">
                    <span>{{ruleForm.hetongshuoming}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.hetongmingcheng = true;
          ...
          if(o=='hetongleixing'){
            this.ruleForm.hetongleixing = obj[o];
	    this.ro.hetongleixing = true;
            continue;
          }
          if(o=='hetongwenjian'){
	    ...
	    this.ro.riqi = true;
          ...
          if(o=='hetongxinxi'){
            this.ruleForm.hetongxinxi = obj[o];
	    this.ro.hetongxinxi = true;
            continue;
          }
          if(o=='hetongshuoming'){
            this.ruleForm.hetongshuoming = obj[o];
	    this.ro.hetongshuoming = true;
            continue;
          }
      ...
      this.$http({
		...
		if(this.$storage.get("role")!="管理员") {
          ...
          this.$message.error(data.msg);
            ...
            this.hetongleixingOptions = "初签,续签,终止,解除".split(',')
            this.$http({
    ...
    yuangonggonghaoChange () {
      this.$http({
        ...
        if (data && data.code === 0) {
              ...
              if(data.data.lingdaozhanghao){
                this.ruleForm.lingdaozhanghao = data.data.lingdaozhanghao
              }
