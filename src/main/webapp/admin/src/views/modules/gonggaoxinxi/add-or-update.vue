      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.gonggaotupian" label="公告图片" prop="gonggaotupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.gonggaotupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="公告内容" prop="gonggaoneirong">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.gonggaoneirong" label="公告内容" prop="gonggaoneirong">
                    <span>{{ruleForm.gonggaoneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.gonggaoleixing = true;
          ...
          if(o=='gonggaotupian'){
            this.ruleForm.gonggaotupian = obj[o];
	    this.ro.gonggaotupian = true;
            continue;
          }
          if(o=='gonggaoneirong'){
	...
	if(this.ruleForm.gonggaotupian!=null) {
		this.ruleForm.gonggaotupian = this.ruleForm.gonggaotupian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    gonggaotupianUploadChange(fileUrls) {
	this.ruleForm.gonggaotupian = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
